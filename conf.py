...
BLOG_AUTHOR = "edgecollective"  # (translatable)
BLOG_TITLE = "Edge Research Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://edgeresearch.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://edgeresearch.io/"
BLOG_EMAIL = "dev@edgeresearch.io"
BLOG_DESCRIPTION = "r&d notes and data"  # (translatable)
